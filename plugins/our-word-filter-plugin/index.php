...
class OurWordFilterPlugin {
    ...
    function ourMenu(){
        ...
        // Using "btoa(``)" in the development console on google chrome, inside the `` paste all the code of the svg and will result in a string full of characters. 
        // You paste that after the "base64," as you can see below
        ...
        // This is another approach when the icon is showed in yellow, instead of matching the color of the other icons 
    ...
    function handleForm() {
        if ( isset($_POST['ourNonce']) AND wp_verify_nonce($_POST['ourNonce'], 'saveFilterWords') AND current_user_can('manage_options')) {
