...
class MyNotes {
  ...
  makeNoteEditable(thisNote) {
    thisNote.find(".edit-note").html('<i class="fa fa-times" aria-hiden="true"></i> Cancel');
    thisNote.find(".note-title-field, .note-body-field").removeAttr("readonly").addClass("note-active-field");
    thisNote.find(".update-note").addClass("update-note--visible");
    thisNote.data("state", "editable");
  }
  makeNoteReadOnly(thisNote) {
    thisNote.find(".edit-note").html('<i class="fa fa-pencil" aria-hiden="true"></i> Edit');
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`
                    <li data-id="${response.id}">
                        ...
                        <span class="edit-note" > <i class="fa fa-pencil" aria-hiden="true"></i> Edit</span>
                        <span class="delete-note" > <i class="fa fa-trash-o" aria-hiden="true"></i> Delete</span>
                        <textarea readonly class="note-body-field" >${response.content.raw}</textarea>
                        <span class="update-note btn btn--blue btn--small" > <i class="fa fa-arrow-right" aria-hiden="true"></i> Save</span>
                    </li>
      ...
      this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.events.length ? '' : `<p>No events match that search. <a href="${universityData.root_url}/evemts">View all events</a> </p>`}                  
